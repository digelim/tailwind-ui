(() => {
            ...
            724: (e, t, n) => {
                ...
                document.addEventListener("click", (function(e) {
                    ...
                    return {
                        ...
                        copied: !1,
                        copyTimeout: void 0,
                        activeSnippet: n.includes(t) ? t : "html",
                        languages: n,
                        snippets: r,
                        init: function() {
                            var e = this,
                        ...
                        highlight: function(e) {
                            ...
                            if (!t.hasAttribute("data-highlighted")) {
                                ...
                                if ("react" === e || "vue" === e) {
                                    ...
                                    Prism.hooks.run("before-tokenize", i), i.tokens = Prism.tokenize(i.code, i.grammar), Prism.hooks.run("after-tokenize", i), t.innerHTML = y(Prism.util.encode(i.tokens), i.language)
    ...
    r.m = t, e = [], r.O = (t, n, i, o) => {
        ...
        var t = (t, n) => {
                ...
                if (c) var d = c(r);
                for (t && t(n); u < a.length; u++) o = a[u], r.o(e, o) && e[o] && e[o][0](), e[a[u]] = 0;
                return r.O(d)
            },
            n = self.webpackChunk = self.webpackChunk || [];
        n.forEach(t.bind(null, 0)), n.push = t.bind(null, n.push.bind(n))
    })(), r.O(void 0, [170], (() => r(724)));
